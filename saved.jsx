...
const SavedPages = () => {
  ...
  const handleDownload = (item) => {
    ...
    if (item.informationType.includes('analysis') && !item.informationType.includes('advanced')) {
        ...
        `;
    } else if (['medicine', 'disease', 'rumour'].includes(item.informationType)) {
        // Medical Dictionary HTML Construction
        let sections = '';
        if (item.informationType === 'medicine') {
            sections = `
            ...
            `;
        } else if (item.informationType === 'disease') {
            sections = `
            ...
            `;
        } else if (item.informationType === 'rumour') {
  ...
  const renderItemContent = (item) => {
    ...
    if (['medicine', 'disease', 'rumour'].includes(informationType)) {
        const data = parseContentSafe(content);

        // Reusable List Renderer tailored for Medical Dictionary Arrays
        ...
        // Reusable Info Block for layout
        ...
        return (
            <div className="medical-dict-saved">
                {/* Header Area with Badge and Download Button */}
